import {
  NoSsr
} from "./chunk-AJOWR2OL.js";
import {
  Popper
} from "./chunk-BUIZPW4S.js";
import "./chunk-ZMXKDN4Y.js";
import "./chunk-4C5JSDHX.js";
import {
  require_react_dom
} from "./chunk-ZW7WJ6XU.js";
import {
  Typography_default
} from "./chunk-THFA7MTE.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-SU55PEUM.js";
import {
  shouldForwardProp
} from "./chunk-OQ63L6W5.js";
import "./chunk-LOXAVPWU.js";
import {
  useSlotProps
} from "./chunk-P7XE3VL4.js";
...
import {
  ...
  useForkRef,
  useId
} from "./chunk-4EFSYIA3.js";
import "./chunk-A77NOW5N.js";
import {
  styled_default
} from "./chunk-A2BXBKAN.js";
import "./chunk-6L3GCBJN.js";
import {
  useThemeProps2 as useThemeProps
} from "./chunk-KPV4PGLJ.js";
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime17.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime17.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime17.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime17.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
var _excluded9 = ["skipAnimation", "onItemClick", "borderRadius"];
...
var useAggregatedData = () => {
  const seriesData = React40.useContext(SeriesContext).bar ?? {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
  const axisData = React40.useContext(CartesianContext);
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React40.Fragment, {
    children: [maskTransition((style, {
      ...
      return (0, import_jsx_runtime28.jsx)(BarClipPath, {
        maskId: id,
        borderRadius,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime28.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color2,
        highlightScope
...
true ? BarPlot.propTypes = {
   ...
   */
  borderRadius: import_prop_types20.default.number,
  /**
...
var ChartsSurface = React42.forwardRef(function ChartsSurface2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime29.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime29.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
function useChartGradient() {
  ...
  return React45.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime32.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime32.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime32.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorScale,
          colorMap,
      ...
      children: (0, import_jsx_runtime33.jsx)(CartesianContextProvider, {
        ...
        children: (0, import_jsx_runtime33.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime33.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime33.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime33.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const [width, setWidth] = React47.useState(0);
  const [height, setHeight] = React47.useState(0);
...
var ResponsiveChartContainer = React48.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
...
var BarChart = React52.forwardRef(function BarChart2(props, ref) {
  ...
  return (0, import_jsx_runtime38.jsxs)(ResponsiveChartContainer, {
    ...
    children: [onAxisClick && (0, import_jsx_runtime38.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime38.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime38.jsxs)("g", {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime38.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), !loading && (0, import_jsx_runtime38.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React53.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React54.Fragment, {
    children: [(0, import_jsx_runtime39.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime39.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime39.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
var _excluded15 = ["id", "classes", "color", "gradientId", "highlightScope", "slots", "slotProps", "onClick"];
...
var _excluded16 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime41.jsx)("g", _extends({}, other, {
    children: completedData.reverse().map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime41.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime42.jsxs)(React57.Fragment, {
    children: [(0, import_jsx_runtime42.jsx)("clipPath", {
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime42.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime43.jsx)(Line, _extends({}, lineProps));
}
...
var _excluded19 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime44.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime44.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var _excluded20 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
true ? MarkElement.propTypes = {
   ...
   */
  shape: import_prop_types31.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
function MarkPlot(props) {
  ...
  const seriesData = React61.useContext(SeriesContext).line;
  const axisData = React61.useContext(CartesianContext);
  const chartId = useChartId();
  ...
  return (0, import_jsx_runtime46.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime46.jsx)("g", {
          clipPath: `url(#${clipId})`,
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime46.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React63.useContext(SeriesContext).line;
  const axisData = React63.useContext(CartesianContext);
  const {
    axis
  ...
  return (0, import_jsx_runtime48.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor2(series[seriesId], xAxis[xAxisKey], yAxis[yAxisKey]);
        return (0, import_jsx_runtime48.jsx)(Element, _extends({
          id: seriesId,
...
var LineChart = React64.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime49.jsxs)(ResponsiveChartContainer, {
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none" && !onAxisClick,
    children: [onAxisClick && (0, import_jsx_runtime49.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime49.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime49.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime49.jsx)(AreaPlot, {
        slots,
        slotProps,
        onItemClick: onAreaClick,
        skipAnimation: skipAnimation2
      }), (0, import_jsx_runtime49.jsx)(LinePlot, {
        slots,
        slotProps,
        onItemClick: onLineClick,
        skipAnimation: skipAnimation2
      }), (0, import_jsx_runtime49.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime49.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime49.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime49.jsx)(MarkPlot, {
      slots,
      slotProps,
      onItemClick: onMarkClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime49.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime49.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), !loading && (0, import_jsx_runtime49.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime49.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? LineChart.propTypes = {
  ...
  xAxis: import_prop_types35.default.arrayOf(import_prop_types35.default.shape({
    ...
    max: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]),
    min: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number]),
    position: import_prop_types35.default.oneOf(["bottom", "left", "right", "top"]),
...
var _excluded25 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "highlightScope", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle"];
...
true ? PieArc.propTypes = {
  ...
  dataIndex: import_prop_types36.default.number.isRequired,
  ...
  isFaded: import_prop_types36.default.bool.isRequired,
  isHighlighted: import_prop_types36.default.bool.isRequired
} : void 0;
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React66.useCallback((dataIndex) => {
...
var _excluded26 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
var _excluded27 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "arcLabelRadius", "outerRadius", "cornerRadius"];
...
true ? PieArcPlot.propTypes = {
   ...
   */
  arcLabelRadius: import_prop_types37.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types37.default.number,
  data: import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
    ...
    endAngle: import_prop_types37.default.number.isRequired,
    formattedValue: import_prop_types37.default.string.isRequired,
    ...
    padAngle: import_prop_types37.default.number.isRequired,
    startAngle: import_prop_types37.default.number.isRequired,
   ...
   */
  faded: import_prop_types37.default.shape({
    additionalRadius: import_prop_types37.default.number,
    arcLabelRadius: import_prop_types37.default.number,
    color: import_prop_types37.default.string,
    cornerRadius: import_prop_types37.default.number,
    innerRadius: import_prop_types37.default.number,
    outerRadius: import_prop_types37.default.number,
    paddingAngle: import_prop_types37.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types37.default.shape({
    additionalRadius: import_prop_types37.default.number,
    arcLabelRadius: import_prop_types37.default.number,
    color: import_prop_types37.default.string,
    cornerRadius: import_prop_types37.default.number,
   ...
   */
  outerRadius: import_prop_types37.default.number.isRequired,
  /**
...
var _excluded28 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types38.default.string,
...
var _excluded29 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "highlightScope", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types39.default.oneOfType([import_prop_types39.default.oneOf(["formattedValue", "label", "value"]), import_prop_types39.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types39.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
...
function PiePlot(props) {
  ...
  const seriesData = React70.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime55.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime55.jsx)(ChartsAxis, {
      ...
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime55.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime55.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime55.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  });
...
true ? PieChart.propTypes = {
  ...
  xAxis: import_prop_types41.default.arrayOf(import_prop_types41.default.shape({
    ...
    max: import_prop_types41.default.oneOfType([import_prop_types41.default.instanceOf(Date), import_prop_types41.default.number]),
    min: import_prop_types41.default.oneOfType([import_prop_types41.default.instanceOf(Date), import_prop_types41.default.number]),
    position: import_prop_types41.default.oneOf(["bottom", "left", "right", "top"]),
...
function Scatter(props) {
  ...
  const highlightScope = React72.useMemo(() => _extends({
    highlighted: "item",
    faded: "global"
  ...
  const cleanData = React72.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types42.default.func,
  markerSize: import_prop_types42.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  xScale: import_prop_types42.default.func.isRequired,
  yScale: import_prop_types42.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const seriesData = React73.useContext(SeriesContext).scatter;
  const axisData = React73.useContext(CartesianContext);
  const {
    zAxis,
    zAxisIds
  } = React73.useContext(ZAxisContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime57.jsx)(React73.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
...
var ScatterChart = React74.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    zAxis,
  ...
  return (0, import_jsx_runtime58.jsx)(ResponsiveChartContainer, {
    ref,
    series: series.map((s2) => _extends({
      type: "scatter"
    }, s2)),
    ...
    yAxis,
    sx,
    children: (0, import_jsx_runtime58.jsxs)(ZAxisContextProvider, {
      zAxis,
      children: [!disableVoronoi && (0, import_jsx_runtime58.jsx)(ChartsVoronoiHandler, {
        voronoiMaxRadius,
        onItemClick
      }), (0, import_jsx_runtime58.jsx)(ChartsAxis, {
        topAxis,
        leftAxis,
        rightAxis,
        bottomAxis,
        slots,
        slotProps
      }), grid && (0, import_jsx_runtime58.jsx)(ChartsGrid, {
        vertical: grid.vertical,
        horizontal: grid.horizontal
        ...
        x: "none",
        y: "none"
      }, axisHighlight)), !loading && (0, import_jsx_runtime58.jsx)(ChartsTooltip, _extends({
        trigger: "item"
      }, tooltip)), children]
    })
  });
...
true ? ScatterChart.propTypes = {
   ...
   * @default false
   */
  disableVoronoi: import_prop_types44.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types44.default.shape({
    horizontal: import_prop_types44.default.bool,
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types44.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types44.default.number,
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types44.default.arrayOf(import_prop_types44.default.shape({
    colorMap: import_prop_types44.default.oneOfType([import_prop_types44.default.shape({
      color: import_prop_types44.default.oneOfType([import_prop_types44.default.arrayOf(import_prop_types44.default.string.isRequired), import_prop_types44.default.func]).isRequired,
      max: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number]),
      min: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number]),
...
var SparkLineChart = React75.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime59.jsxs)(ResponsiveChartContainer, {
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime59.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime59.jsxs)(React75.Fragment, {
      children: [(0, import_jsx_runtime59.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime59.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime59.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime59.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime59.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types45.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types45.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types45.default.arrayOf(import_prop_types45.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types45.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types45.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types45.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types45.default.shape({
...
var GaugeContext = React76.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime60.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React76.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime61 = __toESM(require_jsx_runtime());
var _excluded30 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React77.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
  ...
  const handleRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime61.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime61.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime61.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime61.jsx)(ChartsSurface, {
          width,
          height,
          ref: handleRef,
          title,
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types46.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types46.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types46.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types46.default.number,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime63.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
var _excluded31 = ["text", "className"];
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime64.jsx)("g", {
    className,
    children: (0, import_jsx_runtime64.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
   ...
   * Height of a text line (in `em`).
   */
  lineHeight: import_prop_types47.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types47.default.bool,
...
var _excluded32 = ["text", "children", "classes"];
...
function Gauge(props) {
  ...
  return (0, import_jsx_runtime65.jsxs)(GaugeContainer, _extends({}, other, {
    className: classes.root,
    children: [(0, import_jsx_runtime65.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime65.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime65.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
  ...
  text: import_prop_types48.default.oneOfType([import_prop_types48.default.func, import_prop_types48.default.string]),
