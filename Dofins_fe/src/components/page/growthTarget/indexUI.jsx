...
export default function GrowthTargetUI({
  ...
  return (
    <div>
      <div className=" shadow-[0_10px_100px] rounded-lg w-full  shadow-blue-400 py-4 rounded-md my-3">
        {dofins ? (
      ...
      <div>
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-2 shadow-[0_10px_100px] rounded-lg w-full   shadow-blue-400 py-4 rounded-md my-3">
            {/* <SimpleBarChart /> */}
          </div>
          <div className="shadow-[0_10px_100px] rounded-lg w-full   shadow-blue-400 py-4 rounded-md my-3">
            <LineAndBarChart />
